export const RESOURCE_DEFS = {
  ...
  siliconMass: { id: 'siliconMass', label: '규소 덩어리', emoji: '🧱', order: 9, precision: 0 },
  carbon: { id: 'carbon', label: '탄소', emoji: '⚫', order: 10, precision: 0 },
  siliconIngot: { id: 'siliconIngot', label: '규소 주괴', emoji: '🗞️', order: 11, precision: 0 },
  nickel: { id: 'nickel', label: '니켈', emoji: '🟡', order: 12, precision: 0 },
  lowAlloySteel: { id: 'lowAlloySteel', label: '저합금강', emoji: '🔗', order: 13, precision: 0 },
  highAlloySteel: { id: 'highAlloySteel', label: '고합금강', emoji: '🖇️', order: 14, precision: 0 },
} as const

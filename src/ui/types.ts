...
export type Handlers = {
  ...
  onCraftJunkArmor: () => void
  onCraftIronArmor: () => void
  onArmorCraftTypePrev: () => void
  onArmorCraftTypeNext: () => void
  onEquipArmor: (armorType: import('../core/state.ts').ArmorType) => void
  onUnequipArmor: () => void

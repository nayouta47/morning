...
export function renderBasePanel(state: GameState, actionUI: ActionUI, now = Date.now()): string {
  ...
  return `<section id="panel-base" class="panel-stack ${state.activeTab === 'base' ? '' : 'hidden'}">
      <section class="panel resources"><h2>자원</h2><section class="resources-owned" aria-label="보유 자원"><div class="resource-group">${renderResourceRow('wood', 'res-wood', formatResourceValue('wood', state.resources.wood))}${renderResourceRow('scrap', 'res-scrap', formatResourceValue('scrap', state.resources.scrap))}${renderResourceRow('siliconMass', 'res-silicon-mass', formatResourceValue('siliconMass', state.resources.siliconMass))}</div><div class="resource-group">${renderResourceRow('iron', 'res-iron', formatResourceValue('iron', state.resources.iron))}${renderResourceRow('lowAlloySteel', 'res-low-alloy-steel', formatResourceValue('lowAlloySteel', state.resources.lowAlloySteel))}${renderResourceRow('highAlloySteel', 'res-high-alloy-steel', formatResourceValue('highAlloySteel', state.resources.highAlloySteel))}</div><div class="resource-group">${renderResourceRow('chromium', 'res-chromium', formatResourceValue('chromium', state.resources.chromium))}${renderResourceRow('molybdenum', 'res-molybdenum', formatResourceValue('molybdenum', state.resources.molybdenum))}${renderResourceRow('cobalt', 'res-cobalt', formatResourceValue('cobalt', state.resources.cobalt))}${renderResourceRow('nickel', 'res-nickel', formatResourceValue('nickel', state.resources.nickel))}</div><div class="resource-group">${renderResourceRow('carbon', 'res-carbon', formatResourceValue('carbon', state.resources.carbon))}${renderResourceRow('siliconIngot', 'res-silicon-ingot', formatResourceValue('siliconIngot', state.resources.siliconIngot))}</div><div class="resource-group equipment-group"><p class="resource-group-label">장비</p>${renderResourceRow('shovel', 'res-shovel', `${formatResourceValue('shovel', state.resources.shovel)}/${SHOVEL_MAX_STACK}`)}${renderResourceRow('scavengerDrone', 'res-scavenger-drone', formatResourceValue('scavengerDrone', state.resources.scavengerDrone))}</div></section></section>

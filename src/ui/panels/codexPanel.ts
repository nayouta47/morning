...
const CHIP_CODEX_ENTRIES: ChipCodexEntry[] = [
  ...
  { type: 'heatAmplifierLeft', name: '열 증폭기(좌)', icon: '♨️◀', effect: '기본효과: 즉시 왼쪽 1칸 증폭 +2 / 열장 페널티: 증폭 방향 1칸 고열 10 + 상하좌우 고열 5(증폭기 칩 장착 칸 제외), ⌊열⌋만큼 증폭 감소 및 슬롯 정지', powerCost: 4 },
  { type: 'heatAmplifierRight', name: '열 증폭기(우)', icon: '♨️▶', effect: '기본효과: 즉시 오른쪽 1칸 증폭 +2 / 열장 페널티: 증폭 방향 1칸 고열 10 + 상하좌우 고열 5(증폭기 칩 장착 칸 제외), ⌊열⌋만큼 증폭 감소 및 슬롯 정지', powerCost: 4 },
]

...
function renderChipRows(state: GameState): string {
  return CHIP_CODEX_ENTRIES
    .map((chip) => {
      ...
      const effectCards = `<article class="module-effect-card module-effect-base" aria-label="기본효과"><h4>기본효과</h4><p class="hint">${detail.baseDescription}</p></article><article class="module-effect-card module-effect-amp" aria-label="증폭효과"><h4>증폭효과</h4><p class="hint">${detail.amplifiedDescription}</p></article><article class="module-effect-card module-effect-power" aria-label="전력"><h4>전력</h4><p class="hint">⚡ ${chip.powerCost}</p></article><article class="module-effect-card module-effect-weight" aria-label="무게"><h4>무게</h4><p class="hint">⚖️ ${chip.weight}</p></article>`
